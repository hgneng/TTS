...
class YUE_Phonemizer(BasePhonemizer):
    """🐸TTS yue phonemizer using functions in `TTS.tts.utils.text.cantonese.phonemizer`
    ...
    @staticmethod
    def name():
        return "yue_phonemizer"

    @staticmethod
    def phonemize_yue(text: str, separator: str = "|") -> str:
        ph = cantonese_text_to_phonemes(text, separator)
        return ph

    def _phonemize(self, text, separator):
        return self.phonemize_yue(text, separator)
