...
from TTS.tts.utils.text.phonemizers.yue_phonemizer import YUE_Phonemizer
...
DEF_LANG_TO_PHONEMIZER["yue"] = YUE_Phonemizer.name()
...
def get_phonemizer_by_name(name: str, **kwargs) -> BasePhonemizer:
    ...
    if name == 'yue_phonemizer':
        return YUE_Phonemizer(**kwargs)
